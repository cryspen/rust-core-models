...
/-- [core_models::array::TryFromSliceError]
    Source: 'src/core/array.rs', lines 4:0-4:29
    Visibility: public -/
@[reducible]
def array.TryFromSliceError := Unit

/-- [core_models::array::Dummy]
    Source: 'src/core/array.rs', lines 8:0-8:40 -/
@[reducible]
...
/-- Trait declaration: [core_models::iter::traits::collect::IntoIterator]
    Source: 'src/core/iter.rs', lines 372:8-381:9
    Visibility: public -/
...
/-- [core_models::array::iter::IntoIter]
    Source: 'src/core/array.rs', lines 120:4-120:55
    Visibility: public -/
@[reducible]
...
/-- Trait declaration: [core_models::ops::index::Index]
    Source: 'src/core/ops.rs', lines 144:4-147:5
    Visibility: public -/
...
/-- [core_models::ops::range::Range]
    Source: 'src/core/ops.rs', lines 311:4-314:5
    Visibility: public -/
...
/-- [core_models::option::Option]
    Source: 'src/core/option.rs', lines 3:0-8:1
    Visibility: public -/
@[discriminant isize]
...
/-- Trait declaration: [core_models::iter::traits::iterator::Iterator]
    Source: 'src/core/iter.rs', lines 15:8-19:9
    Visibility: public -/
...
/-- Trait declaration: [core_models::borrow::Borrow]
    Source: 'src/core/borrow.rs', lines 2:0-5:1 -/
...
/-- Trait declaration: [core_models::clone::Clone]
    Source: 'src/core/clone.rs', lines 13:0-16:1
    Visibility: public -/
...
/-- Trait declaration: [core_models::cmp::PartialOrd]
    Source: 'src/core/cmp.rs', lines 30:0-37:1
    Visibility: public -/
...
/-- Trait declaration: [core_models::cmp::Ord]
    Source: 'src/core/cmp.rs', lines 109:0-113:1
    Visibility: public -/
...
/-- [core_models::cmp::Reverse]
    Source: 'src/core/cmp.rs', lines 132:0-132:29
    Visibility: public -/
@[reducible]
...
/-- [core_models::result::Result]
    Source: 'src/core/result.rs', lines 3:0-8:1
    Visibility: public -/
@[discriminant isize]
...
/-- Trait declaration: [core_models::convert::TryInto]
    Source: 'src/core/convert.rs', lines 5:0-10:1 -/
...
/-- [core_models::convert::Infallible]
    Source: 'src/core/convert.rs', lines 44:0-44:22
    Visibility: public -/
@[reducible]
...
/-- Trait declaration: [core_models::fmt::Display]
    Source: 'src/core/fmt.rs', lines 13:0-16:1
    Visibility: public -/
...
/-- Trait declaration: [core_models::error::Error]
    Source: 'src/core/error.rs', lines 4:0-4:35
    Visibility: public -/
...
/-- [core_models::f32::f32]
    Source: 'src/core/f32.rs', lines 4:0-4:11 -/
@[reducible]
def f32.f32 := Unit

/-- [core_models::fmt::Arguments]
    Source: 'src/core/fmt.rs', lines 25:0-25:33
    Visibility: public -/
@[reducible]
def fmt.Arguments := Unit

/-- [core_models::fmt::rt::ArgumentType]
    Source: 'src/core/fmt.rs', lines 52:4-59:5 -/
@[discriminant isize]
...
/-- [core_models::fmt::rt::Argument]
    Source: 'src/core/fmt.rs', lines 61:4-63:5
    Visibility: public -/
structure fmt.rt.Argument where
  ty : fmt.rt.ArgumentType

/-- [core_models::fmt::rt::Count]
    Source: 'src/core/fmt.rs', lines 101:4-105:5 -/
@[discriminant isize]
...
/-- [core_models::fmt::rt::Placeholder]
    Source: 'src/core/fmt.rs', lines 107:4-112:5 -/
...
/-- [core_models::iter::adapters::skip::Skip]
    Source: 'src/core/iter.rs', lines 676:8-679:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::chain::Chain]
    Source: 'src/core/iter.rs', lines 645:8-648:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::filter::Filter]
    Source: 'src/core/iter.rs', lines 614:8-617:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::zip::Zip]
    Source: 'src/core/iter.rs', lines 587:8-590:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::flatten::Flatten]
    Source: 'src/core/iter.rs', lines 543:8-549:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::flat_map::FlatMap]
    Source: 'src/core/iter.rs', lines 505:8-509:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::take::Take]
    Source: 'src/core/iter.rs', lines 479:8-482:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::map::Map]
    Source: 'src/core/iter.rs', lines 453:8-456:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::step_by::StepBy]
    Source: 'src/core/iter.rs', lines 427:8-430:9
    Visibility: public -/
...
/-- [core_models::iter::adapters::enumerate::Enumerate]
    Source: 'src/core/iter.rs', lines 396:8-399:9
    Visibility: public -/
...
/-- Trait declaration: [core_models::iter::traits::collect::FromIterator]
    Source: 'src/core/iter.rs', lines 384:8-387:9
    Visibility: public -/
...
/-- Trait declaration: [core_models::iter::traits::iterator::IteratorMethods]
    Source: 'src/core/iter.rs', lines 22:8-77:9 -/
...
/-- Trait declaration: [core_models::marker::Copy]
    Source: 'src/core/marker.rs', lines 4:0-4:24
    Visibility: public -/
...
/-- Trait declaration: [core_models::marker::Send]
    Source: 'src/core/marker.rs', lines 6:0-6:17
    Visibility: public -/
structure marker.Send (Self : Type) where

/-- Trait declaration: [core_models::marker::Sync]
    Source: 'src/core/marker.rs', lines 8:0-8:17
    Visibility: public -/
structure marker.Sync (Self : Type) where

/-- Trait declaration: [core_models::marker::Sized]
    Source: 'src/core/marker.rs', lines 10:0-10:18
    Visibility: public -/
structure marker.Sized (Self : Type) where

/-- Trait declaration: [core_models::marker::StructuralPartialEq]
    Source: 'src/core/marker.rs', lines 12:0-12:32
    Visibility: public -/
structure marker.StructuralPartialEq (Self : Type) where

/-- [core_models::marker::PhantomData]
    Source: 'src/core/marker.rs', lines 23:0-23:25 -/
@[reducible]
def marker.PhantomData (T : Type) := T

/-- [core_models::mem::manually_drop::ManuallyDrop]
    Source: 'src/core/mem.rs', lines 118:4-120:5
    Visibility: public -/
structure mem.manually_drop.ManuallyDrop (T : Type) where
  value : T

/-- [core_models::num::error::IntErrorKind]
    Source: 'src/core/num/error.rs', lines 24:0-24:24
    Visibility: public -/
@[reducible]
def num.error.IntErrorKind := Unit

/-- [core_models::num::error::ParseIntError]
    Source: 'src/core/num/error.rs', lines 9:0-11:1
    Visibility: public -/
structure num.error.ParseIntError where
  kind : num.error.IntErrorKind

/-- [core_models::num::u8]
    Source: 'src/core/num/mod.rs', lines 392:0-392:14
    Visibility: public -/
@[reducible]
def num.u8 := Unit

/-- [core_models::num::u16]
    Source: 'src/core/num/mod.rs', lines 395:0-395:15
    Visibility: public -/
@[reducible]
def num.u16 := Unit

/-- [core_models::num::u32]
    Source: 'src/core/num/mod.rs', lines 398:0-398:15
    Visibility: public -/
@[reducible]
def num.u32 := Unit

/-- [core_models::num::u64]
    Source: 'src/core/num/mod.rs', lines 401:0-401:15
    Visibility: public -/
@[reducible]
def num.u64 := Unit

/-- [core_models::num::u128]
    Source: 'src/core/num/mod.rs', lines 404:0-404:16
    Visibility: public -/
@[reducible]
def num.u128 := Unit

/-- [core_models::num::usize]
    Source: 'src/core/num/mod.rs', lines 407:0-407:17
    Visibility: public -/
@[reducible]
def num.usize := Unit

/-- [core_models::num::i8]
    Source: 'src/core/num/mod.rs', lines 410:0-410:14
    Visibility: public -/
@[reducible]
def num.i8 := Unit

/-- [core_models::num::i16]
    Source: 'src/core/num/mod.rs', lines 413:0-413:15
    Visibility: public -/
@[reducible]
def num.i16 := Unit

/-- [core_models::num::i32]
    Source: 'src/core/num/mod.rs', lines 416:0-416:15
    Visibility: public -/
@[reducible]
def num.i32 := Unit

/-- [core_models::num::i64]
    Source: 'src/core/num/mod.rs', lines 419:0-419:15
    Visibility: public -/
@[reducible]
def num.i64 := Unit

/-- [core_models::num::i128]
    Source: 'src/core/num/mod.rs', lines 422:0-422:16
    Visibility: public -/
@[reducible]
def num.i128 := Unit

/-- [core_models::num::isize]
    Source: 'src/core/num/mod.rs', lines 425:0-425:17
    Visibility: public -/
@[reducible]
def num.isize := Unit

/-- Trait declaration: [core_models::ops::arith::Add]
    Source: 'src/core/ops.rs', lines 3:4-6:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::Sub]
    Source: 'src/core/ops.rs', lines 8:4-11:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::Mul]
    Source: 'src/core/ops.rs', lines 13:4-16:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::Div]
    Source: 'src/core/ops.rs', lines 18:4-21:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::Neg]
    Source: 'src/core/ops.rs', lines 23:4-26:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::Rem]
    Source: 'src/core/ops.rs', lines 28:4-31:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::AddAssign]
    Source: 'src/core/ops.rs', lines 33:4-35:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::SubAssign]
    Source: 'src/core/ops.rs', lines 37:4-39:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::MulAssign]
    Source: 'src/core/ops.rs', lines 41:4-43:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::DivAssign]
    Source: 'src/core/ops.rs', lines 45:4-47:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::arith::RemAssign]
    Source: 'src/core/ops.rs', lines 49:4-51:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::Shr]
    Source: 'src/core/ops.rs', lines 81:4-84:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::Shl]
    Source: 'src/core/ops.rs', lines 86:4-89:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::BitXor]
    Source: 'src/core/ops.rs', lines 91:4-94:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::BitAnd]
    Source: 'src/core/ops.rs', lines 96:4-99:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::BitOr]
    Source: 'src/core/ops.rs', lines 101:4-104:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::Not]
    Source: 'src/core/ops.rs', lines 106:4-109:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::ShrAssign]
    Source: 'src/core/ops.rs', lines 111:4-113:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::ShlAssign]
    Source: 'src/core/ops.rs', lines 115:4-117:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::BitXorAssign]
    Source: 'src/core/ops.rs', lines 119:4-121:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::BitAndAssign]
    Source: 'src/core/ops.rs', lines 123:4-125:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::bit::BitOrAssign]
    Source: 'src/core/ops.rs', lines 127:4-129:5
    Visibility: public -/
...
/-- [core_models::ops::control_flow::ControlFlow]
    Source: 'src/core/ops.rs', lines 134:4-139:5
    Visibility: public -/
@[discriminant isize]
...
/-- Trait declaration: [core_models::ops::function::FnOnce]
    Source: 'src/core/ops.rs', lines 153:4-157:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::function::FnMut]
    Source: 'src/core/ops.rs', lines 161:4-164:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::function::Fn]
    Source: 'src/core/ops.rs', lines 168:4-171:5
    Visibility: public -/
...
/-- Trait declaration: [core_models::ops::try_trait::FromResidual]
    Source: 'src/core/ops.rs', lines 265:4-267:5 -/
...
/-- Trait declaration: [core_models::ops::try_trait::Try]
    Source: 'src/core/ops.rs', lines 270:4-275:5 -/
...
/-- Trait declaration: [core_models::ops::deref::Deref]
    Source: 'src/core/ops.rs', lines 280:4-284:5
    Visibility: public -/
...
/-- [core_models::slice::Slice]
    Source: 'src/core/slice.rs', lines 5:0-5:19 -/
@[reducible]
def slice.Slice (T : Type) := T

/-- [core_models::slice::iter::Chunks]
    Source: 'src/core/slice.rs', lines 12:4-15:5
    Visibility: public -/
...
/-- [core_models::slice::iter::ChunksExact]
    Source: 'src/core/slice.rs', lines 22:4-25:5
    Visibility: public -/
